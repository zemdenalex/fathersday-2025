 ...
 */
export function getSettingValue(req: Request, res: Response): void {
  try {
 ...
 */
export function resetSettings(req: Request, res: Response): void {
  try {
    const db = getDb();
 ...
 */
export function exportSettings(req: Request, res: Response): void {
  try {
    const db = getDb();
    const settings = getAllSettings(db);
    db.close();
 ...
 */
export function importSettings(req: Request, res: Response): void {
  try {
    const validation = UpdateSettingsSchema.safeParse(req.body);
